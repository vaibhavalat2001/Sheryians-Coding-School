...
exports.NamedTransformations = void 0;
const resource_1 = require("../core/resource.js");
const headers_1 = require("../internal/headers.js");
const path_1 = require("../internal/utils/path.js");
class NamedTransformations extends resource_1.APIResource {
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/v1/named-transformations/${id}`, { body, ...options });
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/v1/named-transformations/${id}`, {
            ...options,
     ...
     */
    get(id, options) {
        return this._client.get((0, path_1.path) `/v1/named-transformations/${id}`, options);
    }
}
exports.NamedTransformations = NamedTransformations;
//# sourceMappingURL=named-transformations.js.map