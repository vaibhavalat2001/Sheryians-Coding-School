...
export interface AssetListParams {
     ...
     * order.
     */
    sort?: 'ASC_NAME' | 'DESC_NAME' | 'ASC_CREATED' | 'DESC_CREATED' | 'ASC_UPDATED' | 'DESC_UPDATED' | 'ASC_HEIGHT' | 'DESC_HEIGHT' | 'ASC_WIDTH' | 'DESC_WIDTH' | 'ASC_SIZE' | 'DESC_SIZE' | 'ASC_RELEVANCE' | 'DESC_RELEVANCE' | 'ASC_DURATION' | 'DESC_DURATION' | 'ASC_ORIGINAL_CREATION_DATE' | 'DESC_ORIGINAL_CREATION_DATE';
    /**
