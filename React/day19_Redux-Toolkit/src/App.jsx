  ...
  return (
    <div className="p-4  flex flex-col justify-center items-center gap-5 text-2xl h-screen bg-black text-white">
      ...
      <div className="flex gap-5">
        <button className="bg-red-500 rounded-xl px-2 py-1" onClick={() => dispatch(increment("argument"))}>Increment</button>
        <button className="bg-red-500 rounded-xl px-2 py-1" onClick={() => dispatch(decrement())}>Decrement</button>
      </div>
      <About/>
    </div>
  );
