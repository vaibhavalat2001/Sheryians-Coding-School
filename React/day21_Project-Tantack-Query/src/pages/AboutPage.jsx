        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="
              ...
              leading-relaxed
            ">
              Our goal is to create a simple and enjoyable shopping
              experience where customers can find products from different
              categories without having to visit multiple stores.
            </p>
            ...
            <p className="
              ...
              leading-relaxed
            ">
              From electronics and fashion to beauty, furniture, groceries
              and home essentials, we bring everything together so you can
      ...
      ">
        ...
        ">
          ...
          <p className="
            ...
            leading-relaxed
          ">
            We believe shopping should be convenient, transparent and
            enjoyable. That's why we're focused on creating a platform
            where discovering great products is simple.
          </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          ...
          ">
            ...
            <p className="
              ...
              leading-relaxed
            ">
              Everything we do is designed around creating a better
              customer experience.
            </p>
          ...
          ">
            ...
            <p className="
              ...
              leading-relaxed
            ">
              We aim to provide quality products across a wide range
              of categories.
            </p>
          ...
          ">
            ...
            <p className="
              ...
              leading-relaxed
            ">
              We work towards making your shopping experience quick
              and convenient.
            </p>
          ...
          ">
            ...
            <p className="
              ...
              leading-relaxed
            ">
              We continuously improve our platform to make shopping
