    ...
    <div className="bg-white rounded-xl overflow-hidden relative xl:w-[18vw] max-xl:w-[25vw] max-lg:w-[30vw] max-md:w-[40vw] h-80 max-sm:w-[39vw] max-sm:h-60">
      ...
      >
        ...
        <button
          ...
          className="bg-purple-600 cursor-pointer hover:bg-purple-400 hover:text-black transaction-active duration-500  hover:scale-120 active:scale-90 px-2 sm:py-0 py-1 sm:text-lg max-sm:text-sm rounded"
        >
          Save
        </button>
      </div>
